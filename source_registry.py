...
_DEFAULT_SOURCES = [
    ...
    {"name": "Centre Hospitalier de Mayotte",
     ...
     "scraper_func": "fetch_chm_tenders", "is_manual": False, "display_order": 27},
    # ── Manuels (accès guidé) ─────────────────────────────────────────────────
    ...
    {"name": "ARMP Madagascar",
     ...
     "category": "International", "is_manual": True, "display_order": 37},
    {"name": "CPB Mauritius — Procurement",
     "url": "https://procurement.govmu.org",
     "category": "International", "is_manual": True, "display_order": 38},
